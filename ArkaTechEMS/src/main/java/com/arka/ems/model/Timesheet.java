...
public class Timesheet {
	...
	public Timesheet(int timesheet_id, String client_name, String start_date, String end_date, int hours, byte[] file,
			String status, String update_date, String file_mime_type, String file_name, ArrayList<TimesheetHours> tsh) {
		super();
	...
	public Timesheet(int timesheet_id, String client_name, String start_date, String end_date, int hours, byte[] file,
			String status, String update_date, String file_mime_type, String file_name) {
		super();
		this.timesheet_id = timesheet_id;
		this.client_name = client_name;
		this.start_date = start_date;
