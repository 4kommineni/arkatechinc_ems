...
<title>TSM - Approved TimeSheets</title>
...
<body>
   ...
   <div class="row">
    ...
    <div id="cell-content" class="carpet cell colspan10 fg-darkBlue">
     <ul class="breadcrumbs2">
      ...
      <li><a href="#">Approved TimeSheets</a></li>
     </ul>
     <h1 class="align-center">Approved TimeSheets</h1>
     <div class="flex-grid">
      <div class="row cell-auto-size">
       <div class="cell">
        <div class="panel margin20">
         <div class="heading">
          <span class="icon fa fa-calendar-check-o fa-lg"></span>
          <span class="title">Approved Time Sheets</span>
         </div>
         <div class="content">
          <div class="flex-grid fg-darkBlue">
           <div class="row cell-auto-size">
            <div class="cell margin20 no-margin-top">
             <table id="approvedTable" class="table border bordered striped hovered cell-hovered">
              <thead>
               <tr>
                <th>Start Date</th>
                <th>End Date</th>
              ...
              <tbody>
               <c:forEach var='ts' items='${alltimesheets}'>
                 <c:if test="${ts.getStatus()  eq 'APPROVED' }">
                <tr>                
 ...
 <script type="text/javascript" src="resources/js/approvedtimesheet.js"></script>
</body>
</html>